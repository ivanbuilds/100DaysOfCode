...
public class mainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblWinners.setFont(new java.awt.Font("Liberation Sans", 0, 14)); // NOI18N
    ...
    private void btnSpinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSpinActionPerformed
        ...
        if (!txtNumberOfWinners .getText().equals("")) {
            
        int numWin = Integer.parseInt(txtNumberOfWinners.getText());
        ...
        if (contSpin <= numWin) {
            ...
            int randomDay = numRandom.nextInt(maximum - minimum + 1) + 1;
            int randomTicket = numRandom.nextInt(9999);

            int longString = (Integer.toString(randomDay)).length();

            String drawNumber;
            if (longString == 2) {
                drawNumber = randomDay + month;
            } else {
                drawNumber = "0" + randomDay + month;
            }

            longString = (Integer.toString(randomTicket)).length();
            if (longString == 3) {
                drawNumber = drawNumber + "0" + randomTicket;
            }
            else {
                if (longString == 2) {
                    drawNumber = drawNumber + "00" + randomTicket;
                }
                else {
                   if (longString == 1) {
                        drawNumber = drawNumber + "000" + randomTicket;
                    }
                   else {
                       drawNumber = drawNumber + randomTicket;
                   }
                }
            }
            ...
            // 
            DefaultTableModel model = (DefaultTableModel) tblWinners.getModel();
            Object[] object = {contSpin, drawNumber};
            model.addRow(object);
            ...
            JOptionPane.showMessageDialog(rootPane, "The number of winners has already been reached");
            }
            } 
            else {

                JOptionPane.showMessageDialog(rootPane, "Enter a number of winners");
            }
    }//GEN-LAST:event_btnSpinActionPerformed

    private void btnEndActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEndActionPerformed
        
        if (JOptionPane.showConfirmDialog(rootPane, "Are you sure you want to end the draw?", "End", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
        
        txtNumberOfWinners.setText("");
